...
- Sprawdź czy **Ripple IP** to **163.172.71.251** i **Mirror IP** to **37.187.125.67**. Jeśli nie, kliknij **Update IP** by dostać pasujące IP.
- Sprawdź czy w przełączniku jest napisane **"You are playing on Ripple server 163.172.71.251 - 37.187.125.67"** (powinno wyglądać jak [to](https://b.catgirlsare.sexy/xqJw.png)), jeśli nie, kliknij **"On/Off"** by zmienić serwer.  
